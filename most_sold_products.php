...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="most_sold_products.php">Most Sold Products</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Most Sold Products</h1>
    ...
    <script>
        ...
        fetchReportBtn.addEventListener('click', fetchMostSoldProducts);
